...
### 2026/09/09 st.set_option("deprecation.showfileUploaderEncoding", False)

st.sidebar.title("シャインマスカット房粒数カウント、収穫時期判定アプリ-ai-app13")
 ...
 if img_file is not None:
    with st.spinner("推定中..."):
        ...
        if  img_source != "カメラで撮影":
           ...
           ### 2026/09/09 st.image(img, caption="対象の画像", use_column_width=True)
